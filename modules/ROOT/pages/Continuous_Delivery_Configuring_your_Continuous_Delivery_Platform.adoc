...
. Click on the image:images/JenkinsPlayButton.png[CDPlayButton] of the "Configure my maven private repository" job.
...
NOTE: The job only allows setting up a single private Maven repository, to set up multiple repos please create a new case on the Customer Service Center.
