...
. You can specify the project directory that contains the Bonita test-toolkit project (see documentation https://documentation.bonitasoft.com/test-toolkit/1.0/process-testing-overview[here]).
