...
image:NonProdBuildForm.png[]

== Launching a deployment

. Click on the image:JenkinsPlayButton.png[CDPlayButton] of the "ACTION - Deploy a LivingApp to a non-production runtime" job.
...
image:NonProdBuildFormDeployDescriptor.png[]
