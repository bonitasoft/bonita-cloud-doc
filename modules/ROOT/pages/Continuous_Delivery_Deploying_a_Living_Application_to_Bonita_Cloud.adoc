...
. You can specify the project directory that contains the Bonita test-toolkit project (see documentation xref:test-toolkit:ROOT:process-testing-overview[here]).
