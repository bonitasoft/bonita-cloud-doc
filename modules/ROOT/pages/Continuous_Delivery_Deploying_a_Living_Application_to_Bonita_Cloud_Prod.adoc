...
When used, if a deploy policy is declared in DEPLOY_JSON, it overrides the other xref:bcd:ROOT:livingapp_deploy#preconfigured_deployment_policies[Development or Production Policies]
