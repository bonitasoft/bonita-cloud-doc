...
* The following bonita configuration files (see xref:{bonitaDocVersion}@bonita:ROOT:single-sign-on-with-oidc.adoc[OpenID Connect SSO configuration] documentation):
