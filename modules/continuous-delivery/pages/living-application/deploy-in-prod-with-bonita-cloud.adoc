...
[NOTE]
====
If your repository contains a `uib/` directory, UIB applications are deployed automatically after the LivingApp deploy. +
To skip UIB deployment for this run, uncheck the **`DEPLOY_UIB`** option. The LivingApp itself will still be deployed.
====
